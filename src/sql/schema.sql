...
CREATE OR REPLACE TABLE SeriesDeeplinks (
    ...
    altSeasonNumber SMALLINT UNSIGNED DEFAULT 0 NULL COMMENT 'If set, this will override the scrapers season number, use it to match the TMDB title',
    episodeNumber SMALLINT UNSIGNED DEFAULT 0 NULL,
    altEpisodeNumber SMALLINT UNSIGNED DEFAULT 0 NULL COMMENT 'If set, this will override the scrapers episode number, use it to match the TMDB title',
    originSource ENUM ('none', 'freecast', 'gracenote', 'reelgood', 'tmdb') DEFAULT 'none' NOT NULL,
    region VARCHAR(10) NULL,
    -- Platform specific links
    web TEXT NULL COMMENT 'Web browser URL',
